...
use torus_attention::{BidirectionalTorusConfig, BidirectionalTorusTransformer, TorusResult};
...
fn main() -> TorusResult<()> {
    ...
    let mut model = BidirectionalTorusTransformer::new(config.clone(), vocab_size, vb, &device)?;
